...
const UserTable : React.FC<Params> = ({userId}) => {
        ...
        <div className='flex justify-between'>                
                <div>
                    <div className='flex gap-2 items-center'>
                        <Link href={'/users'}  className='hover:bg-gray-100 rounded-full p-3 cursor-pointer'>
                            <Image src={BackArrowIcon} alt='' />
                        </Link>
                        <span>BACK</span>
                    </div>
                    <h3 className='mt-[1.7rem] text-[1.6rem] font-bold'>Jehny Wilson,{userId}</h3>
